import { HERO_DESC } from "../constants";
      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            initial="hidden"
            animate="visible"
            className="my-2 max-w-xl py-6 font-light tracking-tight">{HERO_DESC}</motion.p>
          </div>
        </div>
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            src={profilePic} alt="profile" className="max-w-full h-auto" />
          </div>
        </div>
      </div>
    </div>
